...
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER "set_public_warehouse_groups_updated_at"
BEFORE UPDATE ON "public"."warehouse_groups"
FOR EACH ROW
EXECUTE PROCEDURE "public"."set_current_timestamp_updated_at"();
COMMENT ON TRIGGER "set_public_warehouse_groups_updated_at" ON "public"."warehouse_groups" 
